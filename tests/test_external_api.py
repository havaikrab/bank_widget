...
def test_get_currency_rate_by_date(mock_get):
  ...
  "source": "RUB"}
    ...
    mock_get.assert_called_once_with('https://api.apilayer.com/currency_data/historical?date=2022-11-11&source=RUB', headers=test_headers)
...
def test_get_currency_rate_by_date_unauthorized(mock_get, capsys):
    ...
    mock_get.assert_called_with('https://api.apilayer.com/currency_data/historical?date=2022-11-11&source=RUB', headers=test_headers)
